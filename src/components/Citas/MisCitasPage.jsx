    ...
    if (isConfirmed) {
      try {
        ...
        if (statusCode === 400 || statusCode === 409) {
          ...
          const errorMessage =
            backendMessage || 'Hubo un error al cancelar la cita. Por favor, inténtalo de nuevo.';
          alert(errorMessage);
        }
      }
    }
          ...
          >
            ...
            <p className="text-gray-700 mb-2 flex items-center">
              ...
              <span className="font-medium ml-1">
                {new Date(cita.date).toLocaleString('es-GT', {
                  dateStyle: 'full',
                  timeStyle: 'short',
                })}
              </span>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 flex justify-end">
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1
